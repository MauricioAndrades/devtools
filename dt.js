...
/** string prototypes */
;(function(global){String.prototype.findAll=function(string){var matches=[];var i=this.indexOf(string);while(i!==-1){matches.push(i);i=this.indexOf(string,i+string.length)}return matches};String.prototype.replaceControlCharacters=function(){return this.replace(/[\u0000-\u0008\u000b\u000c\u000e-\u001f\u0080-\u009f]/g,"\ufffd")};String.prototype.isWhitespace=function(){return/^\s*$/.test(this)};String.prototype.computeLineEndings=function(){var endings=this.findAll("\n");endings.push(this.length);return endings};
...
b=b.toUpperCase();if(a===b)return 0;return a>b?1:-1}})(window);
...
;(function(global){
	...
	if(typeof($.fn.jquery) !== 'undefined') {
		/*! jQuery v3.1.2-pre -amd | (c) jQuery Foundation | jquery.org/license */ ! function(a, b) {
			"use strict";
