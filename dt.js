...
(function(global){
    var config = {
        ...
        eventListener: 'body',
        eventListenerOptions: {once: true, capture: true},
        eventTarget: false,
